...
INSERT INTO onl_cgreport_head (id, code, name, cgr_sql, return_val_field, return_txt_field, return_type, db_source, content, low_app_id, update_time, update_by, create_time, create_by) VALUES ('1582948857082388482', 'pavilion_user', '用户列表', 'select id,realname,avatar,phone,sellout_count,
buy_count,
good_evaluate_count,
bad_evaluate_count,
  alipay_account
from sys_user', null, null, '1', null, null, null, '2022-10-20 12:17:01', 'admin', '2022-10-20 12:16:32', 'admin');
INSERT INTO onl_cgreport_head (id, code, name, cgr_sql, return_val_field, return_txt_field, return_type, db_source, content, low_app_id, update_time, update_by, create_time, create_by) VALUES ('1582950381938384897', 'pavilion_book', '图书列表', 'select  id,name,author_name,price,cover from pavilion_book', null, null, '1', null, null, null, '2022-10-20 12:32:18', 'admin', '2022-10-20 12:22:36', 'admin');
